%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Numerical simulation of the evolution of a perturbed quantum harmonic
%   oscillator
...
% Set DVR parameters 
T = 40*pi;                      % Time duration of the evolution
M = 10^5;                       % Total No. of steps in the evolution
dt = T/M;                       % Time step
...
ground_state_temp = (hermiteH(0,X)).*exp(-(X-X0).^2/(2*sigma^2));
ground_normalised = ground_state_temp/sqrt(ground_temp * ground_temp');
...
psi_0 = initial_state;   %normalized state
psi = psi_0;
