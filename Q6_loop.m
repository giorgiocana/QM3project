...
% Set DVR parameters 
T = pi*pi*10; %pi*pi ; %5;                  % Time duration of the evolution
...
ylabel('$\ln(\mathrm{Max} ~P_{0\to 2})$', 'FontSize', fs, 'Interpreter', 'latex');
grid on;
...
exportgraphics(gcf, sprintf('Q6_Transition_Growth_w=%.3f_m=%.5f_r=%.5f.png', w, m, r), 'Resolution', 300);
hold off;
