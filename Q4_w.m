...
% Set DVR parameters 
T = 200*pi; %pi*pi*20; %pi*pi ; %5;                  % Time duration of the evolution
...
if plot_transition_probabilities
    ...
    downsample_factor = 10; % Adjust this for smoother curves
    ...
    annotation('textbox', [0.25, 0.625, 0.1, 0.1], ...
               'String', sprintf('$A = %.3f$, $\\omega = %.2f$, $T = %.0f \\pi$', A, w, T / pi), ...
               'Interpreter', 'latex', ...
               'FontSize', fs, ...
